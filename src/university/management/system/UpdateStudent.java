...
public class UpdateStudent extends JFrame implements ActionListener {
    ...
    JLabel labelrollno;       //label value can't be changed.
    ...
    UpdateStudent() {
        ...
        JLabel heading = new JLabel("Update Student Details"); //it is used to print as it is in the prompt.
        ...
        // for roll no.
        JLabel lblrollno = new JLabel("Roll Number"); //it is used to print as it is in the prompt.
        lblrollno.setBounds(50, 200, 200, 30);
        lblrollno.setFont(new Font("serif", Font.BOLD, 20));
        add(lblrollno);

        labelrollno = new JLabel(); //it is used to print as it is in the prompt.
        labelrollno.setBounds(200, 200, 200, 30);
        labelrollno.setFont(new Font("serif", Font.PLAIN, 19));
        add(labelrollno);
        ...
        // for Course
        JLabel lblcourse = new JLabel("Course"); //it is used to print as it is in the prompt.
        ...
        // for branch
        JLabel lblbranch = new JLabel("Branch"); //it is used to print as it is in the prompt.
