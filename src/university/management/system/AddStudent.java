...
public class AddStudent extends JFrame implements ActionListener{
    ...
    AddStudent(){
        ...
        JLabel heading  = new JLabel("New Student Details"); //it is used to print as it is in the prompt.
        ...
        labelrollno  = new JLabel("1533"+first4); //it is used to print as it is in the prompt.
